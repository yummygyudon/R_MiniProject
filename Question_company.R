...
word_lg <- subset(word_lg, names(word_lg) !="무엇"& names(word_lg) !="설명"& names(word_lg) !="이유"& names(word_lg) !="본인"& names(word_lg) !="자기"& names(word_lg) !="자신"& names(word_lg) !="해주"
...
# lgCNS
word_lgCNS <- readLines('com_top10/lgCNS.txt')
